...
export function AddChildCategoryModal({ categories, subCategories }: Props) {
    ...
    function submit(e: React.FormEvent) {
        ...
        post(childCategory.store().url, {
            preserveScroll: true,
            onSuccess: () => {
                toast.success('Дочерняя категория добавлена');
                reset();
                setOpen(false);
            },
        });
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button>Добавить дочернюю категорию</Button>
            </DialogTrigger>

            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Новая дочерняя категория</DialogTitle>
                </DialogHeader>
