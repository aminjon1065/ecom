...
use App\Http\Controllers\Client\InfoPageController;
...
Route::get('/delivery', [InfoPageController::class, 'show'])->defaults('page', 'delivery')->name('info.delivery');
Route::get('/payment', [InfoPageController::class, 'show'])->defaults('page', 'payment')->name('info.payment');
Route::get('/returns', [InfoPageController::class, 'show'])->defaults('page', 'returns')->name('info.returns');
