...
Route::get('coupon/create', [CouponsController::class, 'create'])->name('coupon.create');
Route::post('coupon', [CouponsController::class, 'store'])->name('coupon.store');
Route::get('coupon/{coupon}/edit', [CouponsController::class, 'edit'])->name('coupon.edit');
...
Route::get('popular-searches', [PopularSearchQueryController::class, 'index'])->name('popular-search-query.index');
Route::get('popular-searches/create', [PopularSearchQueryController::class, 'create'])->name('popular-search-query.create');
Route::post('popular-searches', [PopularSearchQueryController::class, 'store'])->name('popular-search-query.store');
Route::get('popular-searches/{popularSearchQuery}/edit', [PopularSearchQueryController::class, 'edit'])->name('popular-search-query.edit');
